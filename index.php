        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body" style="border-bottom-style: solid; border-color:<?= $color ?>; border-width:20px; border-radius:5px; padding-top:40px;">
                    <center>
                        <h1 class="title" style="color:<?= $color ?>; font-size:30px; font-weight:bold">EO GSEA Ambassador Program</h1>
                    </center>
                    <form id='signup_form' enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            ...
                            <div class="rs-select2 js-select-simple select--no-search">
                                <input class="input--style-4" type="text" name="acyear" pattern="[0-9]{4}" required>
                            </div>
                        </div>
